...
./configure --target-os=linux --enable-static --disable-shared --enable-gpl --enable-libx264 --disable-lzma --extra-cflags="-fPIC -I${X264_PATH}/include" --extra-ldflags="-ldl -L${X264_PATH}/lib -lx264" --disable-x86asm --enable-protocol=rtp --enable-network --prefix=./install
make -j8
make install
